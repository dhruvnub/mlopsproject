# app.py — Experiment 4: FastAPI Inference API
# Local:  uvicorn app:app --reload → http://127.0.0.1:8000
# Azure:  Deployed to Azure App Service
...
app = FastAPI(
    ...
    description="Predicts student placement using ML. Deployed on Azure App Service.",
    version="1.0.0",
)
